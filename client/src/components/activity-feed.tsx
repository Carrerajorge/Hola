...
import { useAgentTraceStore, type TraceStep, type TraceRun, type TraceArtifact } from "@/stores/agentTraceStore";
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      {run.startedAt && (
                        <span className="text-xs text-muted-foreground">
                          {formatDistanceToNow(run.startedAt, { addSuffix: true, locale: es })}
                        </span>
                      )}
                    </div>
                    <Progress value={phaseConfig.progress} className="h-1 mt-2" />
                  </div>
                </div>
              )}

              {activeAgentName && activeStep && (
                <ActiveAgentDisplay
