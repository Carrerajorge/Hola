...
export function NewChatButton({
  ...
  const variantClasses = {
    full: "liquid-button flex min-h-[32px] w-full items-center justify-between gap-1.5 rounded-[12px] border border-white/40 bg-white/72 px-2.5 py-1 text-[12px] text-foreground transition-all duration-200 hover:border-[#A5A0FF]/42 hover:bg-white/92 hover:shadow-[0_8px_18px_rgba(96,90,190,0.09)] dark:border-white/10 dark:bg-white/[0.05] dark:hover:bg-white/[0.09]",
    compact: "liquid-button flex min-h-[32px] items-center justify-center gap-1.5 rounded-[12px] border border-white/35 bg-white/70 px-2.5 py-1 text-[12px] text-foreground transition-all duration-200 hover:border-[#A5A0FF]/35 hover:bg-white/88 hover:shadow-[0_8px_18px_rgba(96,90,190,0.09)] dark:border-white/10 dark:bg-white/[0.05] dark:hover:bg-white/[0.08]",
  ...
  const buttonContent = (
    ...
    >
      ...
      {variant === "full" && (
        <kbd className="hidden h-[18px] items-center rounded-md border border-border/80 bg-transparent px-1 text-[8px] text-muted-foreground lg:inline-flex">
          ⌘N
        </kbd>
      )}
    </button>
