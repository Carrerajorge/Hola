...
export function NewChatButton({
  ...
  const variantClasses = {
    full: "liquid-button flex min-h-[35px] w-full items-center justify-between gap-1.5 rounded-[12px] border border-transparent bg-gradient-to-r from-blue-500 to-purple-600 px-2.5 py-1 text-[12px] font-semibold text-white shadow-md transition-all duration-300 hover:from-blue-600 hover:to-purple-700 hover:shadow-[0_8px_18px_rgba(165,160,255,0.2)] hover:-translate-y-0.5 dark:hover:shadow-[0_8px_18px_rgba(165,160,255,0.1)]",
