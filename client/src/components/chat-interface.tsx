                ...
                <Popover>
                  ...
                  <PopoverContent side="top" align="start" className="w-56 p-2">
                    <div className="grid gap-1">
                      ...
                      <Button 
                        variant="ghost" 
                        className="justify-start gap-2 text-sm h-9 opacity-50 cursor-not-allowed"
                        disabled
                        data-testid="button-mcp-figma"
                      >
                        ...
                        Figma
                        <span className="ml-auto text-[10px] text-muted-foreground">Sin configurar</span>
                      </Button>
                    </div>
                  </PopoverContent>
                </Popover>
