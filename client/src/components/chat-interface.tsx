...
import { Composer, UploadedFile as ComposerUploadedFile } from "@/components/composer";
        ...
        <PanelGroup direction="horizontal" className="flex-1">
          ...
          >
            ...
            <Composer
              ...
              onDocTextDeselect={handleDocTextDeselect}
              selectedDocTool={selectedDocTool}
              onCloseDocEditor={closeDocEditor}
              selectedTool={selectedTool}
              onSelectTool={setSelectedTool}
              onSelectDocTool={setSelectedDocTool}
              onOpenBlankDocEditor={openBlankDocEditor}
              onToggleBrowser={() => setIsBrowserOpen(!isBrowserOpen)}
              isBrowserOpen={isBrowserOpen}
              isRecording={isRecording}
              isPaused={isPaused}
              recordingTime={recordingTime}
              onDiscardRecording={discardVoiceRecording}
              ...
              onFigmaDisconnect={handleFigmaDisconnect}
              onCloseSidebar={onCloseSidebar}
              onPreviewUploadedImage={(f) => setPreviewUploadedImage(f)}
