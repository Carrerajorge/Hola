...
export const BUNDLED_SKILLS: BundledSkill[] = [
    ...
    { id: "coding-agent", name: "coding-agent", description: "Asistente de programación para delegar tareas a flujos OpenClaw o Claude Code.", category: "automation", features: ["Generación de código", "Revisión de PRs", "Refactorización autónoma", "Análisis de vulnerabilidades"] },
    ...
    { id: "image-generate-native", name: "image-generate-native", description: "Capacidad nativa de OpenClaw para generar y editar imágenes usando image_generate y un modelo configurado en agents.defaults.imageGenerationModel.", category: "integrations", features: ["Generación nativa de imágenes", "Edición con imágenes de referencia", "Selección de provider/model", "Entrega automática de media"] },
