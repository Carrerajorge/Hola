...
const OAUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  google_not_configured: "El inicio de sesión con Google no está configurado. Contacta al administrador.",
  google_auth_failed: "Error de autenticación con Google. Por favor intenta de nuevo.",
  google_invalid_response: "Google devolvió una respuesta inválida. Intenta de nuevo.",
  google_invalid_state: "La sesión de Google expiró o se perdió durante el regreso. Intenta de nuevo.",
  ...
  google_error: "Error inesperado al iniciar sesión con Google. Intenta de nuevo.",
