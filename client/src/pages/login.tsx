...
const OAUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  session_save_error: "Error al guardar la sesión. Por favor intenta de nuevo.",
  ...
  google_not_configured: "Google OAuth no está configurado en este servidor. Contacta al administrador.",
  google_auth_failed: "Google rechazó la autenticación. Por favor intenta de nuevo.",
  google_invalid_response: "Google no devolvió los datos esperados. Intenta de nuevo.",
  google_invalid_state: "La sesión de autenticación expiró o se perdió. Por favor intenta de nuevo.",
  ...
  google_userinfo_failed: "No se pudo obtener la información de tu cuenta de Google. Intenta de nuevo.",
  google_error: "Error inesperado con Google. Por favor intenta de nuevo.",
