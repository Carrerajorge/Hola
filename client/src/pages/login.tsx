              ...
              >
                {isSocialProviderLoading("openai") || openaiOAuthLoading ? (
                  ...
                  <span className="inline-flex items-center gap-1.5">
                    ...
                    <svg className="h-4 w-4 opacity-40" viewBox="0 0 18 18" aria-hidden="true">
                      ...
                      <path fill="#EA4335" d="M9 3.58c1.32 0 2.5.46 3.44 1.36l2.58-2.58C13.46.9 11.42 0 9 0A9 9 0 0 0 .96 4.94l3.02 2.34C4.68 5.16 6.66 3.58 9 3.58Z"/>
                    </svg>
                  </span>
                )}
