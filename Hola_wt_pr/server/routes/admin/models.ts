    ...
    try {
        ...
        const providers = {
            xai: {
                ...
                latency: healthStatus?.xai?.latencyMs ?? null,
            ...
            gemini: {
                ...
                latency: healthStatus?.gemini?.latencyMs ?? null,
            ...
            openai: {
                ...
                latency: healthStatus?.openai?.latencyMs ?? null,
            ...
            anthropic: {
                ...
                latency: healthStatus?.anthropic?.latencyMs ?? null,
            ...
            deepseek: {
                ...
                latency: healthStatus?.deepseek?.latencyMs ?? null,
...
modelsRouter.post("/:id/test", async (req, res) => {
    try {
        ...
        try {
            const provider = normalizeProvider(model.provider) || "auto";
...
// NOTE: /health implemented above using llmGateway.healthCheck()
