    ...
    try {
        ...
        req.login(sessionUser, async (loginErr) => {
            ...
            req.session.save(async (saveErr: any) => {
                ...
                // provider_hint=openai: The user authenticated via Google to log in
                // to ILIAGPT. The actual OpenAI/ChatGPT OAuth will happen via the
                // device code flow in the auto-connect dialog after redirect.
                // Do NOT save Google tokens as OpenAI tokens — they are not valid
                // for the OpenAI API.
