...
export type ConnectorName = "gmail" | "gemini" | "xai" | "openai" | "openrouter" | "anthropic" | "deepseek" | "database" | "forms";
...
const CONNECTORS: ConnectorName[] = ["gmail", "gemini", "xai", "openai", "openrouter", "anthropic", "deepseek", "database", "forms"];
