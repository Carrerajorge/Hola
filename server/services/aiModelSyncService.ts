...
const KNOWN_MODELS: Record<string, KnownModel[]> = {
  ...
  // ========================================
  // DEEPSEEK MODELS (Official API, OpenAI-compatible)
  // ========================================
  deepseek: [
    { modelId: "deepseek-chat", name: "DeepSeek Chat", contextWindow: 64000, maxOutput: 8192, type: "TEXT", inputCost: "0.0002", outputCost: "0.0008", description: "General-purpose chat model (OpenAI-compatible API)" },
    { modelId: "deepseek-reasoner", name: "DeepSeek Reasoner", contextWindow: 64000, maxOutput: 8192, type: "TEXT", inputCost: "0.0005", outputCost: "0.0020", description: "Reasoning-focused model (OpenAI-compatible API)" },
  ],
