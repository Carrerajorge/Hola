        ...
        if (result.workflowResult) {
          ...
          return res.json({
            ...
            evidence: [{
              ...
              requestId: (result.agentResult as any).trace?.requestId,
              durationMs: (result.agentResult as any).trace?.durationMs || 0,
              retryCount: 0,
              replanEvents: [],
            ...
            summary: {
              ...
              skippedSteps: 0,
              totalDurationMs: (result.agentResult as any).trace?.durationMs || 0,
              replans: 0,
