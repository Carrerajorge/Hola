import { P as resolveAgentModelPrimaryValue, c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-Bhe-9aXV.js";
...
//#endregion
export { resolveSafeBinProfiles as $, parseConfigPath as A, splitCommandChain as B, isSupportedLocalAvatarExtension as C, setConfigOverride as D, resetConfigOverrides as E, normalizeTrustedSafeBinDirs as F, extractShellWrapperInlineCommand as G, matchAllowlist as H, validateSafeBinArgv as I, unwrapKnownDispatchWrapperInvocation as J, isDispatchWrapperExecutable as K, analyzeShellCommand as L, unsetConfigValueAtPath as M, getTrustedSafeBinDirs as N, unsetConfigOverride as O, isTrustedSafeBinPath as P, normalizeSafeBinProfileFixtures as Q, buildEnforcedShellCommand as R, isPathWithinRoot as S, getConfigOverrides as T, resolveAllowlistCandidatePath as U, DEFAULT_SAFE_BINS as V, resolveCommandResolutionFromArgv as W, splitShellArgs as X, unwrapKnownShellMultiplexerInvocation as Y, SAFE_BIN_PROFILES as Z, parseDurationMs as _, resolveConfigSnapshotHash as a, resolveTelegramPreviewStreamMode as at, isAvatarDataUrl as b, TELEGRAM_COMMAND_NAME_PATTERN as c, VERSION as ct, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as d, isSafeExecutableValue as et, isInboundPathAllowed as f, normalizeScpRemoteHost as g, resolveIMessageRemoteAttachmentRoots as h, readConfigFileSnapshotForWrite as i, resolveSlackStreamingMode as it, setConfigValueAtPath as j, getConfigValueAtPath as k, normalizeTelegramCommandName as l, resolveOwnerDisplaySetting as lt, resolveIMessageAttachmentRoots as m, loadConfig as n, resolveDiscordPreviewStreamMode as nt, writeConfigFile as o, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as ot, mergeInboundPathRoots as p, isShellWrapperExecutable as q, readConfigFileSnapshot as r, resolveSlackNativeStreaming as rt, validateConfigObjectWithPlugins as s, resolveAgentMaxConcurrent as st, createConfigIO as t, mapStreamingModeToSlackLegacyDraftStreamMode as tt, resolveTelegramCustomCommands as u, parseByteSize as v, validateJsonSchemaValue as w, isAvatarHttpUrl as x, AVATAR_MAX_BYTES as y, isWindowsPlatform as z };