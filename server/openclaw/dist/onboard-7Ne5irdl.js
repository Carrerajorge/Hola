...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BOg7ooqj.js";
import { t as WizardCancelledError } from "./prompts-y6EYGeUw.js";
import { t as createClackPrompter } from "./clack-prompter-BG34y93f.js";
import { t as assertSupportedRuntime } from "./runtime-guard-B-3UHLnL.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DGAMIyu9.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Brrb9Mxf.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BMOMoEzS.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-BYT-ABsU.js").then((n) => n.i);
