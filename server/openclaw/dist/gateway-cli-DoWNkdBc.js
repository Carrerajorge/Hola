...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BY60SMEv.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-BPlNBgie.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C1vKol8t.js";
import { C as parseByteSize, Ct as resolveAgentMaxConcurrent, D as isAvatarImageDataUrl, E as isAvatarHttpUrl, S as parseDurationMs, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, ft as applyMergePatch, i as loadConfig, j as looksLikeAvatarPath, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, pt as applyLegacyMigrations, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, w as AVATAR_MAX_BYTES, wt as resolveSubagentMaxConcurrent } from "./config-Bkwnzpys.js";
...
import { $ as resolveMainSessionKey, A as readSessionMessages, B as cleanStaleLockFiles, D as archiveSessionTranscripts, E as archiveFileOnDisk, F as stripEnvelopeFromMessages, G as resolveSessionResetPolicy, L as stripInlineDirectiveTagsForDisplay, N as resolveSessionTranscriptCandidates, O as capArrayByJsonBytes, P as stripEnvelopeFromMessage, Q as resolveExplicitAgentSessionKey, R as stripInlineDirectiveTagsFromMessageForDisplay, S as mergeDeliveryContext, U as evaluateSessionFreshness, X as canonicalizeMainSessionAlias, Z as resolveAgentMainSessionKey, b as deliveryContextFromSession, c as loadSessionStore, et as resolveMainSessionKeyFromConfig, h as updateSessionStore, j as readSessionPreviewItemsFromTranscript, k as cleanupArchivedSessionTranscripts, n as extractDeliveryInfo, nt as snapshotSessionOrigin, r as parseSessionThreadInfo, w as normalizeSessionDeliveryFields } from "./sessions-ECFvKx1f.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-DiQVUE1V.js";
import { n as resolveWhatsAppAccount } from "./accounts-PH1dKbVZ.js";
import "./accounts-BTB26Iiz.js";
import "./accounts-B2H0iPgD.js";
import { t as buildChannelAccountBindings } from "./bindings-DieZWR44.js";
import "./logging-CFvkxgcX.js";
import "./send-DkCCE1dy.js";
import "./send-CTwQ_dUk.js";
import { $ as resolveCronStyleNow, $n as resolveTtsApiKey, $t as setPreRestartDeferralCheck, A as createOutboundSendDeps$1, An as DEFAULT_INPUT_MAX_REDIRECTS, At as normalizeOptionalSessionKey, Bt as buildSafeExternalPrompt, C as sleepWithAbort, Cn as parseVerboseOverride, Cr as getAgentRunContext, D as resolveAgentOutboundTarget, Dt as normalizeCronJobPatch, E as resolveAgentDeliveryPlan, Et as normalizeCronJobCreate, Fn as resolveInputFileLimits, Ft as buildDeliveryFromLegacyPayload, Gn as stopSubagentsForRequester, Gt as persistBrowserProxyFiles, Ht as getHookType, In as resolveAgentTimeoutMs, It as hasLegacyDeliveryHints, J as getTotalPendingReplies, Jn as resolveUserTimezone, Jt as emitGatewayRestart, K as dispatchInboundMessage, Kt as consumeGatewaySigusr1RestartAuthorization, Lt as stripLegacyDeliveryFields, Mn as extractFileContentFromSource, Mt as normalizePayloadToSystemText, Nn as extractImageContentFromSource, Nt as normalizeRequiredName, O as createOutboundSendDeps, On as DEFAULT_INPUT_IMAGE_MAX_BYTES, Ot as inferLegacyName, Pn as normalizeMimeList, Pt as migrateLegacyCronPayload, Qn as isTtsProviderConfigured, Qt as setGatewaySigusr1RestartPolicy, R as buildHistoryContextFromEntries, S as computeBackoff, Sn as applyVerboseOverride, Sr as emitAgentEvent, St as summarizeRestartSentinel, Tn as isSystemEventContextChanged, Tr as registerAgentRunContext, Tt as normalizeHttpWebhookUrl, Ut as isExternalHookSession, Vn as formatZonedTimestamp, Vt as detectSuspiciousPatterns, Wn as isAbortTrigger, Wt as applyBrowserProxyPaths, Xn as getTtsProvider, Xt as markGatewaySigusr1RestartHandled, Yn as clearBootstrapSnapshot, Yt as isGatewaySigusr1RestartExternallyAllowed, Z as BARE_SESSION_RESET_PROMPT, Zn as isTtsEnabled, Zt as scheduleGatewaySigusr1Restart, _ as loadOpenClawPlugins, a as runSubagentAnnounceFlow, ar as setTtsProvider, at as resolveAnnounceTargetFromKey, b as readJsonBodyWithLimit, br as stripHeartbeatToken, bt as formatRestartSentinelMessage, c as abortEmbeddedPiRun, cr as OPENAI_TTS_VOICES, ct as resolveOutboundSessionRoute, d as applyToolPolicyPipeline, dn as requestHeartbeatNow, dr as getTotalQueueSize, dt as resolveOutboundTarget, en as unbindThreadBindingsBySessionKey, er as resolveTtsAutoMode, et as getCliSessionId, f as buildDefaultToolPolicyPipelineSteps, fr as resetAllLanes, ft as resolveSessionDeliveryTarget, gn as resolveSessionAuthProfileOverride, gr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, gt as runWithModelFallback, h as resolvePluginTools, hn as resolveSendPolicy, hr as CommandLane, ir as setTtsEnabled, it as readLatestAssistantReply, j as resolveAgentAvatar, jn as DEFAULT_INPUT_TIMEOUT_MS, jt as normalizeOptionalText, k as createDefaultDeps, kn as DEFAULT_INPUT_IMAGE_MIMES, kt as normalizeOptionalAgentId, l as getActiveEmbeddedRunCount, lr as getActiveTaskCount, m as getPluginToolMeta, mn as normalizeSendPolicy, mr as waitForActiveTasks, mt as resetDirectoryCache, n as initSubagentRegistry, nr as resolveTtsPrefsPath, nt as runCliAgent, o as clearSessionQueues, or as textToSpeech, pr as setCommandLaneConcurrency, q as createReplyDispatcher, qt as deferGatewayRestartUntilIdle, r as listDescendantRunsForRequester, rn as loadProviderUsageSummary, rr as resolveTtsProviderOrder, rt as createOpenClawTools, s as runEmbeddedPiAgent, sr as OPENAI_TTS_MODELS, st as ensureOutboundSessionEntry, t as countActiveDescendantRuns, tn as normalizeGroupActivation, tr as resolveTtsConfig, tt as setCliSessionId, u as waitForEmbeddedPiRunEnd, vt as consumeRestartSentinel, w as agentCommand, wn as enqueueSystemEvent, wr as onAgentEvent, wt as writeRestartSentinel, x as requestBodyErrorToText, xn as applyModelOverrideToSessionEntry, xr as clearAgentRunContext, y as handleSlackHttpRequest, yt as formatDoctorNonInteractiveHint } from "./subagent-registry--qOHOvSD.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-CNcGRgMH.js";
import { C as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, x as getGlobalHookRunner } from "./deliver-t508rlg0.js";
...
import { d as loadCronStore, f as resolveCronStorePath, p as saveCronStore } from "./send-BHdBDBgV.js";
import { c as detectMime } from "./image-ops-CdtmwUCR.js";
import "./pi-embedded-helpers-CuapwR3w.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-CphQTZ8D.js";
import { i as listCoreToolSections, n as PROFILE_OPTIONS, o as resolveCoreToolProfiles } from "./tool-catalog-CgUG8wjb.js";
...
import { c as ensureGatewayStartupAuth, l as mergeGatewayTailscaleConfig } from "./server-context-BpiGFhJz.js";
import { i as compileSafeRegex } from "./redact-CjuqjXFe.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-DjnYuRJy.js";
import { n as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-CRRUKIv2.js";
import { t as movePathToTrash } from "./trash-z9Vvqm2l.js";
import { t as SsrFBlockedError } from "./ssrf-BZES7RNw.js";
import "./store-B12_ELOe.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-Do_TimBK.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-XSn4asPp.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-C_Ihzx4u.js";
import { n as resolveMemorySearchConfig } from "./manager-ClH4Sdfs.js";
import "./gemini-auth-8rJrmPae.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Cu0jqikd.js";
import "./query-expansion-BI-SeFWF.js";
import "./retry-BpId8ooT.js";
import { a as ToolInputError } from "./target-errors-DzFj0Ep8.js";
...
import { r as isRestartEnabled } from "./commands-DoesZR2k.js";
import "./commands-registry-BH0UPGo4.js";
import { S as extractTextFromChatContent } from "./image-oQ_7PD7w.js";
import "./tool-display-DVVqZPLw.js";
import { d as registerUnhandledRejectionHandler } from "./runner-D2Q8tYn3.js";
import { n as loadModelCatalog } from "./model-catalog-DeOJC3gy.js";
...
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-CWF3BV_E.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CwBsWZoU.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-08-PAzXR.js";
import "./fetch-G_zevKM2.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-eoetsTzS.js";
import "./nodes-screen-BFD50GSA.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-mpxdYjpK.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-DCo0YVlg.js";
import { t as getChannelActivity } from "./channel-activity-elbmR4Fp.js";
import { n as normalizePollInput } from "./polls-Bcm5V2E_.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-GAWZorkV.js";
...
import { t as formatHelpExamples } from "./help-format-BucQ45AN.js";
import { n as withProgress } from "./progress-uJ7y1rnQ.js";
import "./replies-Cpu7oY9H.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-BOg7ooqj.js";
import "./prompt-style-GlggG8xB.js";
import "./pairing-labels-6V2NMRi3.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-CIY5LSeb.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-Ci_E3_RC.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-F-GmGMfp.js";
import { n as inheritOptionFromParent } from "./command-options-f3s5QES5.js";
import { t as buildChannelUiCatalog } from "./catalog-BhvgAZ5q.js";
import { t as WizardCancelledError } from "./prompts-y6EYGeUw.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BB7G1nTV.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-B4Hdf6hr.js";
import { t as isWithinDir } from "./path-safety-DhHfed5i.js";
import "./install-safe-path-D08lNQQU.js";
import "./skill-scanner-C37yH9ls.js";
import { t as buildChannelAccountSnapshot } from "./status-DNLnVQZ4.js";
import "./channels-status-issues-BWpo_JOB.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-DiHx2ZTV.js";
...
import "./lifecycle-core-BA4DE24a.js";
import "./systemd-hints-CYEwEA6W.js";
import { t as parsePort$1 } from "./parse-port-mxwDyw1k.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-Bx_s0ruJ.js";
import "./diagnostics-BPqqkkac.js";
import "./table-CN-9Ymm9.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CfweTTbv.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-CM1-1_OR.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-BbtS8y4m.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DfBB_JC_.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Bf8f1XLk.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BYT-ABsU.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DNGIkgyu.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-34KCHzJH.js";
import { t as runOnboardingWizard } from "./onboarding-Cqv7HYLx.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-A3yh2vIh.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DZmM9Y4l.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BZodEV1u.js";
import "./dm-policy-shared-D-BNPYn2.js";
import "./node-service-Bj8jOCFo.js";
import "./status.update-Uk3xpr3a.js";
import { t as resolveSystemRunCommand } from "./system-run-command-B9yVVhpy.js";
import { t as installSkill } from "./skills-install-GwKcOvgP.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-C_SYSbFw.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-D-euZwe0.js";
import { n as forceFreePortAndWait } from "./ports-C8vT_t1d.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DWrYVvQg.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-mpxdYjpK.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-BgicimnU.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-B3d6yaGl.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-t508rlg0.js").then((n) => n.n);
