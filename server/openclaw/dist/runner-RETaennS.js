import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-BbLbkVXD.js";
import { J as logVerbose, Z as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-BoKOAh1n.js";
import { _ as runExec } from "./workspace-PSi34tZF.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-B5NjONwE.js";
...
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DS-8ZE_B.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BSL4BVGN.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
