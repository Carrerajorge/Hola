...
import { St as loadProviderUsageSummary, Tt as resolveUsageProviderId, Yt as describeFailoverError, br as buildAuthHealthSummary, l as runEmbeddedPiAgent, vr as maskApiKey, wt as formatUsageWindowSummary, xr as formatRemainingShort, yr as DEFAULT_OAUTH_WARN_MS } from "./reply-D-ejYZny.js";
import { A as resolveAgentModelFallbackValues, M as toAgentModelListLike, O as resolveDefaultAgentWorkspaceDir, i as resolveAgentDir, j as resolveAgentModelPrimaryValue, l as resolveAgentWorkspaceDir, o as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, u as resolveDefaultAgentId } from "./agent-scope-CetJgM-R.js";
import { f as defaultRuntime } from "./subsystem-DkqfG4LL.js";
import "./exec-BvIdloyw.js";
import { $ as getShellEnvAppliedKeys, At as setAuthProfileOrder, Lt as resolveAuthStorePathForDisplay, Nt as ensureAuthProfileStore, Ot as listProfilesForProvider, Rt as resolveOpenClawAgentDir, Wt as resolveAuthProfileDisplayLabel, X as resolveAwsSdkEnvVarName, Xt as DEFAULT_MODEL, Y as resolveApiKeyForProvider, Z as resolveEnvApiKey, Zt as DEFAULT_PROVIDER, g as resolveModelRefFromString, i as findNormalizedProviderValue, it as shouldEnableShellEnvFallback, jt as upsertAuthProfile, l as normalizeProviderId, m as resolveDefaultModelForAgent, mt as resolveAuthProfileOrder, p as resolveConfiguredModelRef, q as getCustomProviderApiKey, r as buildModelAliasIndex, s as modelKey, u as parseModelRef, yt as resolveProfileUnusableUntilForDisplay } from "./model-selection-BGu7OGe6.js";
...
import { S as parseDurationMs, i as loadConfig } from "./config-Cix160T5.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-BatVPulR.js";
...
import { r as resolveForwardCompatModel } from "./model-BJ_FlRZw.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-CjmvIzl5.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-Ca0KE-dW.js";
import "./help-format-BiGlS7JG.js";
import { r as withProgressTotals } from "./progress-ICIHPEsE.js";
...
import { f as openUrl } from "./onboard-helpers-WQ9I7CYo.js";
...
import { t as createClackPrompter } from "./clack-prompter-CVtAwtc6.js";
import { t as renderTable } from "./table-Bd_gPSug.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BfMsIOH_.js";
import { n as redactSecrets } from "./format-Duo-96z8.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DWMWIVMG.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Bfcbe_64.js";
import { n as logConfigUpdated } from "./logging-mGzP9ZHZ.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BtN2JvFS.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-Cix160T5.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-BGu7OGe6.js").then((n) => n.pt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CjmvIzl5.js");
