...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-DkqfG4LL.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-Cix160T5.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-WQ9I7CYo.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DKdqEY_Y.js";
...
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-Cie8d4Wz.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C43peBOr.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DPqJcg4s.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CnvLkGPS.js").then((n) => n.i);
