...
import { At as getShellEnvAppliedKeys, E as resolveOpenClawAgentDir, Et as resolveEnvApiKey, Ft as shouldEnableShellEnvFallback, G as resolveModelRefFromString, H as resolveConfiguredModelRef, I as modelKey, Jt as DEFAULT_PROVIDER, M as buildModelAliasIndex, N as findNormalizedProviderValue, R as normalizeProviderId, St as getCustomProviderApiKey, T as resolveAuthStorePathForDisplay, Tt as resolveAwsSdkEnvVarName, U as resolveDefaultModelForAgent, Yt as resolveAuthProfileDisplayLabel, g as listProfilesForProvider, n as resolveAuthProfileOrder, qt as DEFAULT_MODEL, s as resolveProfileUnusableUntilForDisplay, v as setAuthProfileOrder, wt as resolveApiKeyForProvider, x as ensureAuthProfileStore, y as upsertAuthProfile, z as parseModelRef } from "./auth-profiles-Do5usXx5.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { A as resolveAgentModelFallbackValues, M as toAgentModelListLike, O as resolveDefaultAgentWorkspaceDir, i as resolveAgentDir, j as resolveAgentModelPrimaryValue, l as resolveAgentWorkspaceDir, o as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, u as resolveDefaultAgentId } from "./agent-scope-BUKPOSoo.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-TOqtHLpL.js";
import { r as resolveForwardCompatModel } from "./model-DwWVwtsY.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CwESh4K1.js";
import { S as parseDurationMs, i as loadConfig } from "./config-Bkwnzpys.js";
import { _n as maskApiKey, _t as describeFailoverError, an as formatUsageWindowSummary, bn as formatRemainingShort, on as resolveUsageProviderId, rn as loadProviderUsageSummary, s as runEmbeddedPiAgent, vn as DEFAULT_OAUTH_WARN_MS, yn as buildAuthHealthSummary } from "./subagent-registry--qOHOvSD.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-Dvmk_rXi.js";
import { t as ensureOpenClawModelsJson } from "./models-config-Br-Jfk1e.js";
import { n as loadModelCatalog } from "./model-catalog-DeOJC3gy.js";
import { r as withProgressTotals } from "./progress-uJ7y1rnQ.js";
import { f as openUrl } from "./onboard-helpers-BOg7ooqj.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-GlggG8xB.js";
import { t as createClackPrompter } from "./clack-prompter-BG34y93f.js";
import { t as renderTable } from "./table-CN-9Ymm9.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BTgi-Ci7.js";
import { n as redactSecrets } from "./format-CLjTypC5.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DzjZV7qH.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BNeSu6JH.js";
import { n as logConfigUpdated } from "./logging-BwnxXHZs.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BVvcQzVi.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-Bkwnzpys.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./auth-profiles-Do5usXx5.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-DwWVwtsY.js").then((n) => n.t);
