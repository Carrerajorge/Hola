...
import { Rt as resolveOpenClawAgentDir } from "./model-selection-BGu7OGe6.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-C1gdgALv.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
