...
import { S as parseDurationMs, ct as splitShellArgs, i as loadConfig } from "./config-Bkwnzpys.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-BI-SeFWF.js";
import { t as formatDocsLink } from "./links-XNJ1dvk5.js";
import { r as withManager } from "./cli-utils-fSG_7xFh.js";
import { t as formatHelpExamples } from "./help-format-BucQ45AN.js";
import { n as withProgress, r as withProgressTotals } from "./progress-uJ7y1rnQ.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-Du_Ml_Ru.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-ClH4Sdfs.js").then((n) => n.t);
