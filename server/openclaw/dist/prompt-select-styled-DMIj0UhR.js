...
import { C as updateAuthProfileStoreWithLock, H as resolveConfiguredModelRef, Jt as DEFAULT_PROVIDER, P as getModelRefStatus, W as resolveHooksGmailModel, Xt as CLAUDE_CLI_PROFILE_ID, Zt as CODEX_CLI_PROFILE_ID, l as resolveApiKeyForProfile, m as repairOAuthProfileIdMismatch, qt as DEFAULT_MODEL, s as resolveProfileUnusableUntilForDisplay, wt as resolveApiKeyForProvider, x as ensureAuthProfileStore } from "./auth-profiles-Do5usXx5.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { i as resolveAgentDir, l as resolveAgentWorkspaceDir, m as DEFAULT_AGENTS_FILENAME, u as resolveDefaultAgentId } from "./agent-scope-BUKPOSoo.js";
...
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-Bkwnzpys.js";
import { $ as resolveMainSessionKey, B as cleanStaleLockFiles, c as loadSessionStore, it as isPrimarySessionTranscriptFileName, rt as formatSessionArchiveTimestamp } from "./sessions-ECFvKx1f.js";
import { n as listChannelPlugins } from "./plugins-DiQVUE1V.js";
import { _ as loadOpenClawPlugins, bn as formatRemainingShort, vn as DEFAULT_OAUTH_WARN_MS, yn as buildAuthHealthSummary } from "./subagent-registry--qOHOvSD.js";
...
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BMTeFRaA.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-BEAjYacy.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-CphQTZ8D.js";
import { a as resolveGatewayAuth } from "./auth-Dw00sIWu.js";
import { a as formatPortDiagnostics, n as inspectPortUsage } from "./ports-Do_TimBK.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-C_Ihzx4u.js";
...
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-ChJK8ZR-.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DO13_z-Q.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-BOg7ooqj.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-GlggG8xB.js";
import { t as note$1 } from "./note-Cu03Pnds.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BWpo_JOB.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-CTcLWx9h.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DGAMIyu9.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-C7cCuFWt.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-hCvzihWT.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-CYEwEA6W.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BPqqkkac.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CdLgGyAX.js";
import { r as healthCommand } from "./health-BYT-ABsU.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-DNGIkgyu.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-34KCHzJH.js";
import { t as resolveDmAllowState } from "./dm-policy-shared-D-BNPYn2.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-C_SYSbFw.js";
import { n as logConfigUpdated } from "./logging-BwnxXHZs.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CINnryZy.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DpRBFUJn.js";
import { t as formatHealthCheckFailure } from "./health-format-D4-miW7E.js";
import { n as doctorShellCompletion } from "./doctor-completion-Bz8ehQbd.js";
