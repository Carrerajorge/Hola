...
import { i as loadConfig, l as writeConfigFile, o as readConfigFileSnapshot, r as createConfigIO } from "./config-Bkwnzpys.js";
...
import { a as formatPortDiagnostics, i as classifyPortListener, n as inspectPortUsage } from "./ports-Do_TimBK.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel } from "./constants-ChJK8ZR-.js";
import { r as isWSLEnv } from "./wsl-DO13_z-Q.js";
import { t as formatDocsLink } from "./links-XNJ1dvk5.js";
import { n as withProgress } from "./progress-uJ7y1rnQ.js";
import { g as resolveControlUiLinks, h as randomToken } from "./onboard-helpers-BOg7ooqj.js";
import { n as inheritOptionFromParent } from "./command-options-f3s5QES5.js";
import { t as buildGatewayInstallPlan } from "./daemon-install-helpers-CTcLWx9h.js";
...
async function runDaemonRestart(opts = {}) {
	...
	return await runServiceRestart({
		...
		postRestartCheck: async ({ warnings, fail, stdout }) => {
			...
			fail(`Gateway restart timed out after ${restartWaitSeconds}s waiting for health checks.`, [formatCliCommand("openclaw gateway status --probe --deep"), formatCliCommand("openclaw doctor")]);
		}
	});
}
