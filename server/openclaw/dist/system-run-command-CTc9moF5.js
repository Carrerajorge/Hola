import { rt as hasEnvManipulationBeforeShellWrapper, tt as extractShellWrapperCommand } from "./config-Cix160T5.js";
...
function validateSystemRunCommandConsistency(params) {
	...
	const inferred = shellCommand !== null && !envManipulationBeforeShellWrapper ? shellCommand.trim() : formatExecCommand(params.argv);
