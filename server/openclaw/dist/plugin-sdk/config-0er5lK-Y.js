...
import { B as resolveUserPath, J as isPlainObject$1, N as isRecord, R as resolveConfigDir, c as CHANNEL_IDS, p as normalizeChatChannelId } from "./subsystem-DDlKm7JR.js";
import { $ as loadShellEnvFallback, Y as DEFAULT_CONTEXT_TOKENS, at as normalizeEnvVarKey, c as normalizeProviderId, et as resolveShellEnvFallbackTimeoutMs, it as isDangerousHostEnvVarName, l as parseModelRef, nt as shouldEnableShellEnvFallback, rt as isDangerousHostEnvOverrideVarName, tt as shouldDeferShellEnvFallback } from "./model-selection-CfBXvztJ.js";
import { P as resolveAgentModelPrimaryValue, c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-S0PcYLol.js";
import { c as normalizePluginsConfig, d as isPathInside, l as resolveEffectiveEnableState, t as loadPluginManifestRegistry, u as resolveMemorySlotDecision } from "./manifest-registry-J3QGS9aQ.js";
...
function resolveDispatchWrapperExecutionPlan(argv, maxDepth = MAX_DISPATCH_WRAPPER_DEPTH) {
	...
	for (let depth = 0; depth < maxDepth; depth += 1) {
		...
		if (isSemanticDispatchWrapperUsage(unwrap.wrapper, current)) return {
			argv: current,
			wrappers,
			policyBlocked: true,
			blockedWrapper: unwrap.wrapper
...
//#endregion
export { setConfigValueAtPath as $, MarkdownConfigSchema as A, VERSION as At, parseByteSize as B, resolveIMessageRemoteAttachmentRoots as C, mapStreamingModeToSlackLegacyDraftStreamMode as Ct, DmConfigSchema as D, resolveTelegramPreviewStreamMode as Dt, BlockStreamingCoalesceSchema as E, resolveSlackStreamingMode as Et, TtsModeSchema as F, isSupportedLocalAvatarExtension as G, isAvatarDataUrl as H, TtsProviderSchema as I, resetConfigOverrides as J, validateJsonSchemaValue as K, normalizeAllowFrom as L, ReplyRuntimeConfigSchemaShape as M, TtsAutoSchema as N, DmPolicySchema as O, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as Ot, TtsConfigSchema as P, parseConfigPath as Q, requireOpenAllowFrom as R, resolveIMessageAttachmentRoots as S, isSafeExecutableValue as St, ToolPolicySchema as T, resolveSlackNativeStreaming as Tt, isAvatarHttpUrl as U, AVATAR_MAX_BYTES as V, isPathWithinRoot as W, unsetConfigOverride as X, setConfigOverride as Y, getConfigValueAtPath as Z, normalizeTelegramCommandName as _, unwrapKnownShellMultiplexerInvocation as _t, resolveConfigSnapshotHash as a, analyzeShellCommand as at, isInboundPathAllowed as b, normalizeSafeBinProfileFixtures as bt, WhatsAppConfigSchema as c, splitCommandChain as ct, IMessageConfigSchema as d, resolveAllowlistCandidatePath as dt, unsetConfigValueAtPath as et, MSTeamsConfigSchema as f, resolveCommandResolutionFromArgv as ft, TELEGRAM_COMMAND_NAME_PATTERN as g, unwrapKnownDispatchWrapperInvocation as gt, TelegramConfigSchema as h, isShellWrapperExecutable as ht, readConfigFileSnapshotForWrite as i, validateSafeBinArgv as it, MarkdownTableModeSchema as j, resolveOwnerDisplaySetting as jt, GroupPolicySchema as k, resolveAgentMaxConcurrent as kt, DiscordConfigSchema as l, DEFAULT_SAFE_BINS as lt, SlackConfigSchema as m, isDispatchWrapperExecutable as mt, loadConfig as n, isTrustedSafeBinPath as nt, writeConfigFile as o, buildEnforcedShellCommand as ot, SignalConfigSchema as p, extractShellWrapperInlineCommand as pt, getConfigOverrides as q, readConfigFileSnapshot as r, normalizeTrustedSafeBinDirs as rt, validateConfigObjectWithPlugins as s, isWindowsPlatform as st, createConfigIO as t, getTrustedSafeBinDirs as tt, GoogleChatConfigSchema as u, matchAllowlist as ut, resolveTelegramCustomCommands as v, splitShellArgs as vt, normalizeScpRemoteHost as w, resolveDiscordPreviewStreamMode as wt, mergeInboundPathRoots as x, resolveSafeBinProfiles as xt, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as y, SAFE_BIN_PROFILES as yt, parseDurationMs as z };