...
import { Z as logVerbose, et as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-DDlKm7JR.js";
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-0er5lK-Y.js";
import { E as resolveApiKeyForProvider, H as resolveOpenClawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-CfBXvztJ.js";
import { E as runExec, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-S0PcYLol.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-DukJmgIX.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-C8dbOA2p.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-3Xef4JBF.js";
import { t as normalizeChatType } from "./chat-type-nF1vanR8.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-Cq1KSeA8.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BsGZZy-M.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-USgP67DB.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
