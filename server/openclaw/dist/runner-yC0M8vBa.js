import { E as runExec, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-Bhe-9aXV.js";
import { J as logVerbose, Z as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-n4tSscKk.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-DDLFzohK.js";
...
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-B9aqyKN_.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CL_t0bqK.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
