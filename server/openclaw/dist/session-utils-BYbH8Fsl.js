...
import { E as resolveOpenClawAgentDir, H as resolveConfiguredModelRef, Jt as DEFAULT_PROVIDER, Kt as DEFAULT_CONTEXT_TOKENS, U as resolveDefaultModelForAgent, qt as DEFAULT_MODEL, z as parseModelRef } from "./auth-profiles-Do5usXx5.js";
...
import { A as isWorkspaceRelativeAvatarPath, E as isAvatarHttpUrl, M as resolveAvatarMime, O as isPathWithinRoot, T as isAvatarDataUrl, i as loadConfig, w as AVATAR_MAX_BYTES } from "./config-Bkwnzpys.js";
import { $ as resolveMainSessionKey, M as readSessionTitleFieldsFromTranscript, X as canonicalizeMainSessionAlias, Y as resolveFreshSessionTotalTokens, Z as resolveAgentMainSessionKey, at as buildGroupDisplayName, c as loadSessionStore, w as normalizeSessionDeliveryFields } from "./sessions-ECFvKx1f.js";
...
function sameFileIdentity(left, right) {
	return (left.dev === right.dev || process.platform === "win32" && (left.dev === 0 || right.dev === 0)) && left.ino === right.ino;
}
