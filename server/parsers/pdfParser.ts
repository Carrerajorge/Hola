...
// Security limits
const PDF_MAX_FILE_SIZE = Number(process.env.PDF_MAX_FILE_SIZE_MB || process.env.MAX_FILE_SIZE_MB || "2048") * 1024 * 1024;
...
export class PdfParser implements FileParser {
  ...
  private readonly TIMEOUT_MS = Number(process.env.PDF_PARSE_TIMEOUT_MS || "300000");
