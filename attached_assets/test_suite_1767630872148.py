...
async def test_security_guard_safe_commands():
    ...
    from agente_ia_v5 import SecurityGuard
...
async def test_cache_manager():
    ...
    from agente_ia_v5 import CacheManager
...
async def test_rate_limiter():
    ...
    from agente_ia_v5 import RateLimiter
...
async def test_command_executor():
    ...
    from agente_ia_v5 import CommandExecutor, SecurityGuard
...
async def test_file_manager():
    ...
    from agente_ia_v5 import FileManager, SecurityGuard
...
async def test_document_creator_pptx():
    ...
    from agente_ia_v5 import DocumentCreator
...
async def test_task_planner_intents():
    ...
    from agente_ia_v5 import TaskPlanner
...
async def test_agent_initialization():
    ...
    from agente_ia_v5 import Agent, AgentConfig
