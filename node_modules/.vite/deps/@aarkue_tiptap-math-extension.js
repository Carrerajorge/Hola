...
import {
  ...
  PasteRule,
  mergeAttributes
} from "./chunk-OPRAF6S3.js";
import {
  __commonJS,
  __toESM
} from "./chunk-RZ55PUNP.js";

// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/Token.js
var require_Token = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/Token.js"(exports) {
    "use strict";
    ...
    Token.patterns = /* @__PURE__ */ new Map([
      [Token.TYPE_LPAREN, /(\(|\[|{|\\left\(|\\left\[)/],
      // Match (, [, {, \left(, \left[
      [Token.TYPE_RPAREN, /(\)|]|}|\\right\)|\\right])/],
      // Match ), ], }, \right), \right]
      [Token.TYPE_PLUS, /\+/],
      [Token.TYPE_MINUS, /-/],
      [Token.TYPE_TIMES, /\*/],
...
// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/util/arities.js
var require_arities = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/util/arities.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/util/localFunctions.js
var require_localFunctions = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/util/localFunctions.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var fact = exports.fact = function fact2(a) {
      a = Math.round(a);
      var result = 1;
      if (a < 0) {
    ...
    var frac = exports.frac = function frac2(a, b) {
      return a / b;
    };
    var logn = exports.logn = function logn2(x, b) {
      return Math.log(x) / Math.log(b);
    };
    var rootn = exports.rootn = function rootn2(x, n) {
      return Math.pow(x, 1 / n);
    };
    var sec = exports.sec = function src(x) {
      return 1 / Math.cos(x);
    };
    var csc = exports.csc = function csc2(x) {
      return 1 / Math.sin(x);
    };
    var cot = exports.cot = function cot2(x) {
      return 1 / Math.tan(x);
    };
    var locals = { fact, frac, logn, rootn, sec, csc, cot };
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = void 0;
    try {
      for (_iterator = Object.getOwnPropertyNames(Math)[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        k = _step.value;
        locals[k] = Math[k];
      }
    } catch (err) {
...
// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/util/replaceToken.js
var require_replaceToken = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/util/replaceToken.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/lexer.js
var require_lexer = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/lexer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _Token = require_Token();
    var _Token2 = _interopRequireDefault(_Token);
    var _arities = require_arities();
    var _arities2 = _interopRequireDefault(_arities);
    var _localFunctions = require_localFunctions();
    var _localFunctions2 = _interopRequireDefault(_localFunctions);
    var _replaceToken = require_replaceToken();
    ...
    function lexer(equation) {
      var constants = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      var opts = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : DEFAULT_OPTS;
    ...
    var Lexer = (function() {
      function Lexer2(buffer, constants, opts) {
      ...
      _createClass(Lexer2, [{
        ...
        value: function lexExpression() {
          var charMode = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
          while (this.hasNext()) {
        ...
        key: "next",
        value: function next() {
          var len = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : void 0;
          this.skipWhitespace();
          if (!this.hasNext()) {
...
// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/Node.js
var require_Node = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/Node.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      _createClass(Node2, [{
        ...
        value: function evaluate(vars) {
          ...
          switch (this.type) {
            case Node2.TYPE_FUNCTION:
              ...
              break;
            case Node2.TYPE_INVERSE:
              result = 1 / this.child.evaluate(vars);
              break;
            case Node2.TYPE_NEGATE:
              result = -this.child.evaluate(vars);
              break;
            case Node2.TYPE_NUMBER:
              result = this.value;
              break;
            case Node2.TYPE_POWER:
              result = Math.pow(this.children[0].evaluate(vars), this.children[1].evaluate(vars));
              break;
            case Node2.TYPE_PRODUCT:
        ...
        value: function simplify() {
          if (this.children.length > 1 || this.isUnary()) {
            var newNode = new Node2(this.type, this.value);
...
// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/parser.js
var require_parser = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/parser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/evaluatex.js
var require_evaluatex = __commonJS({
  "node_modules/.pnpm/evaluatex@2.2.0/node_modules/evaluatex/dist/evaluatex.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.default = evaluatex2;
    ...
    function evaluatex2(expression) {
      var constants = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
// node_modules/.pnpm/@aarkue+tiptap-math-extension@1.4.0_@tiptap+core@3.20.0_@tiptap+pm@3.20.0__@tiptap+pm@3.20.0/node_modules/@aarkue/tiptap-math-extension/dist/index.js
var import_evaluatex = __toESM(require_evaluatex());
function generateID() {
...
function evaluateExpression(latex, variables, variableListeners) {
  try {
    ...
    const res = (0, import_evaluatex.default)(changedLatex, {}, { latex: true });
    ...
    if (definesVariable !== void 0) {
      if (definedVariableID === void 0) {
...
function updateEvaluation(latex, id, resultSpan, showEvalResult, editorStorage) {
  let evalRes = evaluateExpression(latex, editorStorage.variables, editorStorage.variableListeners);
...
var DEFAULT_OPTIONS = { addInlineMath: true, evaluation: false, delimiters: "dollar", renderTextMode: "raw-latex" };
var InlineMathNode = Node3.create({
  name: "inlineMath",
  group: "inline",
  inline: true,
  selectable: true,
      ...
      inputRules.push(new InputRule({
        ...
        handler: (props) => {
          ...
          let content = [
            {
              type: "inlineMath",
              attrs: { latex, evaluate: showRes ? "yes" : "no", display: "yes" }
            }
          ];
          props.chain().insertContentAt({
            from: props.range.from,
            to: props.range.to
          }, content, { updateSelection: true }).run();
        }
      }));
    }
    const inlineRegex = getRegexFromOptions("inline", this.options);
    if (inlineRegex !== void 0) {
      inputRules.push(new InputRule({
        ...
        handler: (props) => {
          ...
          if ((this.options.delimiters === void 0 || this.options.delimiters === "dollar") && (props.match[1].startsWith("$") || props.match[0].startsWith("$$"))) {
            return;
          }
          let latex = props.match[1];
          latex = latex.trim();
          ...
          let content = [
            {
              type: "inlineMath",
              attrs: { latex, evaluate: showRes ? "yes" : "no", display: "no" }
            }
          ];
          props.chain().insertContentAt({
            from: props.range.from,
    ...
    if (blockRegex !== void 0) {
      pasteRules.push(new PasteRule({
        ...
        handler: (props) => {
          ...
          props.chain().insertContentAt({ from: props.range.from, to: props.range.to }, [
            {
              type: "inlineMath",
  ...
  renderHTML({ node, HTMLAttributes }) {
    ...
    return [
      ...
      getDelimiter(node.attrs.display === "yes" ? "block" : "inline", "start", this.options) + latex + getDelimiter(node.attrs.display === "yes" ? "block" : "inline", "end", this.options)
    ];
  },
  renderText({ node }) {
  ...
  addNodeView() {
    return ({ HTMLAttributes, node, getPos, editor }) => {
      ...
      katex.render(latex, span, Object.assign({ displayMode, throwOnError: false }, (_a = this.options.katexOptions) !== null && _a !== void 0 ? _a : {}));
...
function getRegexFromOptions(mode, options) {
  if (options.delimiters === void 0 || options.delimiters === "dollar") {
    if (mode === "inline") {
...
var MATH_EXTENSION_NAME = "mathExtension";
var MathExtension = Extension.create({
...
export {
  ...
  MATH_EXTENSION_NAME,
  MathExtension,
  MathExtension as default
};
//# sourceMappingURL=@aarkue_tiptap-math-extension.js.map
