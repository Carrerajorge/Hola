...
var TableView = class {
  ...
  constructor(hotInstance) {
    _classPrivateMethodInitSpec2(this, _TableView_brand);
  ...
  render() {
    if (!this.hot.isRenderSuspended()) {
      ...
      _assertClassBrand2(_TableView_brand, this, _updateScrollbarClassNames).call(this);
    ...
    const walkontableConfig = {
      ...
      rowHeaders: () => {
        ...
        if (this.hot.getSettings().ariaTags) {
          if (_assertClassBrand2(_TableView_brand, this, _getAriaColcount).call(this) === this.hot.countCols()) {
            _assertClassBrand2(_TableView_brand, this, _updateAriaColcount).call(this, _classPrivateFieldGet(_rowHeadersCount, this));
          }
        }
...
function _updateAriaColcount(delta) {
  const colCount = _assertClassBrand2(_TableView_brand, this, _getAriaColcount).call(this) + delta;
...
var ExtendMetaPropertiesMod = class {
  constructor(metaManager) {
    ...
    _classPrivateFieldInitSpec2(this, _initOnlyCallback, (propName, value, isInitialChange) => {
      if (!isInitialChange) {
  ...
  extendMetaProps() {
    this.propDescriptors.forEach((descriptor, alias) => {
      ...
      if (onChange) {
        ...
        this.installPropWatcher(alias, origProp, _classPrivateFieldGet2(_initOnlyCallback, this));
...
var CellRangeToRenderableMapper = class {
  constructor(_ref) {
    ...
    _classPrivateMethodInitSpec3(this, _CellRangeToRenderableMapper_brand);
    _classPrivateFieldInitSpec3(this, _rowIndexMapper, void 0);
    _classPrivateFieldInitSpec3(this, _columnIndexMapper, void 0);
    _classPrivateFieldSet2(_rowIndexMapper, this, rowIndexMapper);
    _classPrivateFieldSet2(_columnIndexMapper, this, columnIndexMapper);
  }
  /**
  ...
  toRenderable(range) {
    ...
    const from = _assertClassBrand4(_CellRangeToRenderableMapper_brand, this, _getNearestNotHiddenCoords).call(this, range.from, rowDirection, columnDirection);
    if (from === null) {
      return null;
    }
    const to = _assertClassBrand4(_CellRangeToRenderableMapper_brand, this, _getNearestNotHiddenCoords).call(this, range.to, -rowDirection, -columnDirection);
    if (to === null) {
      return null;
    }
...
function _getNearestNotHiddenCoords(coords, rowSearchDirection) {
  ...
  const nextVisibleRow = _assertClassBrand4(_CellRangeToRenderableMapper_brand, this, _getNearestNotHiddenIndex).call(this, _classPrivateFieldGet3(_rowIndexMapper, this), coords.row, rowSearchDirection);
  if (nextVisibleRow === null) {
    return null;
  }
  const nextVisibleColumn = _assertClassBrand4(_CellRangeToRenderableMapper_brand, this, _getNearestNotHiddenIndex).call(this, _classPrivateFieldGet3(_columnIndexMapper, this), coords.col, columnSearchDirection);
...
// node_modules/handsontable/focusManager/constants.mjs
var SCOPE_TYPES = Object.freeze({
  INLINE: "inline",
  MODAL: "modal"
});
var FOCUS_SOURCES = Object.freeze({
  UNKNOWN: "unknown",
  CLICK: "click",
  TAB_FROM_ABOVE: "tab_from_above",
  TAB_FROM_BELOW: "tab_from_below"
});
var DEFAULT_SHORTCUTS_CONTEXT = "grid";

// node_modules/handsontable/focusManager/utils/focusDetector.mjs
...
// node_modules/handsontable/focusManager/scope.mjs
function createFocusScope(hotInstance, container) {
  ...
  const activate = function() {
    ...
    let activationSource = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : FOCUS_SOURCES.UNKNOWN;
...
// node_modules/handsontable/focusManager/eventListener.mjs
...
// node_modules/handsontable/focusManager/scopeManager.mjs
function createFocusScopeManager(hotInstance) {
  ...
  function activateScope(scope) {
    let focusSource = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : FOCUS_SOURCES.UNKNOWN;
...
// node_modules/handsontable/focusManager/grid.mjs
...
var FocusGridManager = class {
  constructor(hotInstance) {
    _classPrivateMethodInitSpec4(this, _FocusGridManager_brand);
    _classPrivateFieldInitSpec4(this, _hot, void 0);
    _classPrivateFieldInitSpec4(this, _focusMode, void 0);
    _classPrivateFieldInitSpec4(this, _refocusDelay, 1);
    _classPrivateFieldInitSpec4(this, _refocusElementGetter, null);
    _classPrivateFieldInitSpec4(this, _debouncedSelect, /* @__PURE__ */ new Map());
    _classPrivateFieldInitSpec4(this, _hasSelectionChange, false);
    _classPrivateFieldSet3(_hot, this, hotInstance);
  }
  init() {
    var _this = this;
    const hotSettings = _classPrivateFieldGet4(_hot, this).getSettings();
    _classPrivateFieldSet3(_focusMode, this, hotSettings.imeFastEdit ? FOCUS_MODES.MIXED : FOCUS_MODES.CELL);
    _classPrivateFieldGet4(_hot, this).addHook("afterUpdateSettings", function() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return _assertClassBrand5(_FocusGridManager_brand, _this, _onUpdateSettings).call(_this, ...args);
    });
    _classPrivateFieldGet4(_hot, this).addHook("afterSelection", function() {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return _assertClassBrand5(_FocusGridManager_brand, _this, _onAfterSelectionChange).call(_this, ...args);
    });
    _classPrivateFieldGet4(_hot, this).addHook("afterSelectionFocusSet", function() {
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      return _assertClassBrand5(_FocusGridManager_brand, _this, _onAfterSelectionChange).call(_this, ...args);
    });
    _classPrivateFieldGet4(_hot, this).addHook("afterSelectionEnd", function() {
      for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
        args[_key4] = arguments[_key4];
      }
      return _assertClassBrand5(_FocusGridManager_brand, _this, _focusEditorElement).call(_this, ...args);
    });
    _classPrivateFieldGet4(_hot, this).addHook("afterRender", function() {
      for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
        args[_key5] = arguments[_key5];
      }
      return _assertClassBrand5(_FocusGridManager_brand, _this, _onAfterRender).call(_this, ...args);
    });
  }
  /**
   ...
   */
  getFocusMode() {
    return _classPrivateFieldGet4(_focusMode, this);
  }
  /**
   * Set the focus mode.
   *
  ...
  setFocusMode(focusMode) {
    if (Object.values(FOCUS_MODES).includes(focusMode)) {
      _classPrivateFieldSet3(_focusMode, this, focusMode);
    } else {
   ...
   */
  getRefocusDelay() {
    return _classPrivateFieldGet4(_refocusDelay, this);
  }
  /**
  ...
  setRefocusDelay(delay) {
    _classPrivateFieldSet3(_refocusDelay, this, delay);
  }
  /**
  ...
  setRefocusElementGetter(getRefocusElementFunction) {
    _classPrivateFieldSet3(_refocusElementGetter, this, getRefocusElementFunction);
  }
  /**
  ...
  getRefocusElement() {
    ...
    if (typeof _classPrivateFieldGet4(_refocusElementGetter, this) === "function") {
      return _classPrivateFieldGet4(_refocusElementGetter, this).call(this);
    }
    return (_classPrivateFieldGet22 = _classPrivateFieldGet4(_hot, this).getActiveEditor()) === null || _classPrivateFieldGet22 === void 0 ? void 0 : _classPrivateFieldGet22.TEXTAREA;
  }
  /**
  ...
  focusOnHighlightedCell(selectedCell) {
    const focusElement = (element) => {
      ...
      const currentHighlightCoords = (_classPrivateFieldGet32 = _classPrivateFieldGet4(_hot, this).getSelectedRangeActive()) === null || _classPrivateFieldGet32 === void 0 ? void 0 : _classPrivateFieldGet32.highlight;
      if (!currentHighlightCoords) {
        return;
      }
      let elementToBeFocused = _classPrivateFieldGet4(_hot, this).runHooks("modifyFocusedElement", currentHighlightCoords.row, currentHighlightCoords.col, element);
      if (!isHTMLElement(elementToBeFocused)) {
        elementToBeFocused = element;
      }
      if (elementToBeFocused && !((_classPrivateFieldGet42 = _classPrivateFieldGet4(_hot, this).getActiveEditor()) !== null && _classPrivateFieldGet42 !== void 0 && _classPrivateFieldGet42.isOpened())) {
    ...
    if (selectedCell) {
      ...
      _assertClassBrand5(_FocusGridManager_brand, this, _getSelectedCell).call(this, (element) => focusElement(element));
    }
  }
  /**
  ...
  refocusToEditorTextarea() {
    ...
    let delay = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : _classPrivateFieldGet4(_refocusDelay, this);
    if (_classPrivateFieldGet4(_hot, this).getSettings().imeFastEdit && !((_classPrivateFieldGet52 = _classPrivateFieldGet4(_hot, this).getActiveEditor()) !== null && _classPrivateFieldGet52 !== void 0 && _classPrivateFieldGet52.isOpened())) {
      var _classPrivateFieldGet6, _classPrivateFieldGet7;
      (_classPrivateFieldGet6 = _classPrivateFieldGet4(_hot, this).getActiveEditor()) === null || _classPrivateFieldGet6 === void 0 || (_classPrivateFieldGet7 = _classPrivateFieldGet6.refreshValue) === null || _classPrivateFieldGet7 === void 0 || _classPrivateFieldGet7.call(_classPrivateFieldGet6);
      if (!_classPrivateFieldGet4(_debouncedSelect, this).has(delay)) {
        _classPrivateFieldGet4(_debouncedSelect, this).set(delay, debounce(() => {
          if (!_classPrivateFieldGet4(_hot, this).isDestroyed) {
      ...
      _classPrivateFieldGet4(_debouncedSelect, this).get(delay)();
    }
  }
};
function _getSelectedCell(callback) {
  var _classPrivateFieldGet8;
  const highlight = (_classPrivateFieldGet8 = _classPrivateFieldGet4(_hot, this).getSelectedRangeActive()) === null || _classPrivateFieldGet8 === void 0 ? void 0 : _classPrivateFieldGet8.highlight;
  if (!highlight || !_classPrivateFieldGet4(_hot, this).selection.isCellVisible(highlight)) {
    callback(null);
    return;
  }
  const cell = _classPrivateFieldGet4(_hot, this).getCell(highlight.row, highlight.col, true);
  if (cell === null) {
    _classPrivateFieldGet4(_hot, this).addHookOnce("afterScroll", () => {
      callback(_classPrivateFieldGet4(_hot, this).getCell(highlight.row, highlight.col, true));
    });
  } else {
    callback(cell);
  }
...
function _focusCell() {
  _assertClassBrand5(_FocusGridManager_brand, this, _getSelectedCell).call(this, (selectedCell) => {
    const {
      activeElement
    } = _classPrivateFieldGet4(_hot, this).rootDocument;
...
function _onAfterSelectionChange() {
  _classPrivateFieldSet3(_hasSelectionChange, this, true);
}
function _onAfterRender() {
  if (_classPrivateFieldGet4(_hasSelectionChange, this)) {
    _classPrivateFieldSet3(_hasSelectionChange, this, false);
    _assertClassBrand5(_FocusGridManager_brand, this, _focusCell).call(this);
  }
}
...
// node_modules/handsontable/focusManager/utils/utils.mjs
...
// node_modules/handsontable/focusManager/scopes/grid.mjs
...
// node_modules/handsontable/focusManager/scopes/index.mjs
...
var _hot2 = /* @__PURE__ */ new WeakMap();
...
var StylesHandler = class {
  ...
  constructor(_ref) {
    ...
    _classPrivateFieldInitSpec5(this, _hot2, void 0);
    _classPrivateFieldInitSpec5(this, _themeName, void 0);
    _classPrivateFieldInitSpec5(this, _rootElement, void 0);
    _classPrivateFieldInitSpec5(this, _rootComputedStyle, void 0);
    _classPrivateFieldInitSpec5(this, _rootDocument, void 0);
    _classPrivateFieldInitSpec5(this, _isClassicTheme, true);
    _classPrivateFieldInitSpec5(this, _cssVars, {});
    _classPrivateFieldInitSpec5(this, _computedStyles, {});
    _classPrivateFieldInitSpec5(this, _onThemeChange, void 0);
    _classPrivateFieldSet4(_hot2, this, hot);
    _classPrivateFieldSet4(_rootElement, this, _rootElement2);
    _classPrivateFieldSet4(_rootDocument, this, _rootDocument2);
    _classPrivateFieldSet4(_onThemeChange, this, onThemeChange);
  }
  /**
   ...
   */
  isClassicTheme() {
    return _classPrivateFieldGet5(_isClassicTheme, this);
  }
  /**
  ...
  getCSSVariableValue(variableName) {
    ...
    if (_classPrivateFieldGet5(_isClassicTheme, this)) {
      return null;
    }
    if (_classPrivateFieldGet5(_cssVars, this)[`--ht-${variableName}`]) {
      return _classPrivateFieldGet5(_cssVars, this)[`--ht-${variableName}`];
    }
    const acquiredValue = (_assertClassBrand$cal = _assertClassBrand6(_StylesHandler_brand, this, _getParsedNumericCSSValue).call(this, `--ht-${variableName}`)) !== null && _assertClassBrand$cal !== void 0 ? _assertClassBrand$cal : _assertClassBrand6(_StylesHandler_brand, this, _getCSSValue).call(this, `--ht-${variableName}`);
    if (acquiredValue !== null) {
      _classPrivateFieldGet5(_cssVars, this)[`--ht-${variableName}`] = acquiredValue;
  ...
  getStyleForTD(cssProperty) {
    var _classPrivateFieldGet22;
    return (_classPrivateFieldGet22 = _classPrivateFieldGet5(_computedStyles, this)) === null || _classPrivateFieldGet22 === void 0 ? void 0 : _classPrivateFieldGet22.td[cssProperty];
  }
  /**
  ...
  getDefaultRowHeight(visualRowIndex) {
    ...
    const rowHeight = _assertClassBrand6(_StylesHandler_brand, this, _calculateRowHeight).call(this);
    if (!rowHeight) {
      return CLASSIC_THEME_DEFAULT_HEIGHT;
    }
    if (visualRowIndex !== void 0 && visualRowIndex === _classPrivateFieldGet5(_hot2, this).view.getFirstRenderedVisibleRow()) {
      return rowHeight + 1;
    }
    return rowHeight;
  }
  ...
  useTheme(themeName) {
    if (!themeName) {
      _classPrivateFieldSet4(_themeName, this, void 0);
      _classPrivateFieldSet4(_isClassicTheme, this, true);
      _classPrivateFieldGet5(_onThemeChange, this).call(this, _classPrivateFieldGet5(_themeName, this));
      _assertClassBrand6(_StylesHandler_brand, this, _cacheStylesheetValues).call(this);
      return;
    }
    if (themeName && themeName !== _classPrivateFieldGet5(_themeName, this)) {
      if (!/ht-theme-.*/.test(themeName)) {
        warn(`Invalid theme name: ${themeName}. Please provide a valid theme name.`);
        _classPrivateFieldSet4(_themeName, this, void 0);
        _classPrivateFieldSet4(_isClassicTheme, this, false);
        _classPrivateFieldGet5(_onThemeChange, this).call(this, _classPrivateFieldGet5(_themeName, this));
        _assertClassBrand6(_StylesHandler_brand, this, _cacheStylesheetValues).call(this);
        return;
      }
      if (_classPrivateFieldGet5(_themeName, this)) {
        _assertClassBrand6(_StylesHandler_brand, this, _clearCachedValues).call(this);
      }
      _classPrivateFieldSet4(_themeName, this, themeName);
      _classPrivateFieldSet4(_isClassicTheme, this, false);
      _classPrivateFieldGet5(_onThemeChange, this).call(this, _classPrivateFieldGet5(_themeName, this));
      _assertClassBrand6(_StylesHandler_brand, this, _cacheStylesheetValues).call(this);
    }
   ...
   */
  getThemeName() {
    return _classPrivateFieldGet5(_themeName, this);
  }
};
...
function _cacheStylesheetValues() {
  if (!this.isClassicTheme()) {
    _classPrivateFieldSet4(_rootComputedStyle, this, getComputedStyle(_classPrivateFieldGet5(_rootElement, this)));
  }
  const stylesForTD = _assertClassBrand6(_StylesHandler_brand, this, _getStylesForTD).call(this, ["box-sizing", "border-bottom-width"]);
  _classPrivateFieldGet5(_computedStyles, this).td = {
    ..._classPrivateFieldGet5(_computedStyles, this).td,
    ...{
...
function _getStylesForTD(cssProps) {
  const rootDocument = _classPrivateFieldGet5(_rootDocument, this);
  const rootElement = _classPrivateFieldGet5(_rootElement, this);
...
function _getParsedNumericCSSValue(property) {
  const parsedValue = Math.ceil(parseFloat(_assertClassBrand6(_StylesHandler_brand, this, _getCSSValue).call(this, property)));
  return Number.isNaN(parsedValue) ? null : parsedValue;
}
function _getCSSValue(property) {
  const acquiredValue = _classPrivateFieldGet5(_rootComputedStyle, this).getPropertyValue(property);
  return acquiredValue === "" ? null : acquiredValue;
}
function _clearCachedValues() {
  _classPrivateFieldSet4(_computedStyles, this, {});
  _classPrivateFieldSet4(_cssVars, this, {});
  _classPrivateFieldSet4(_isClassicTheme, this, true);
}
...
Handsontable.buildDate = "20/11/2025 13:26:54";
...
//# sourceMappingURL=chunk-TTTLMFA2.js.map
