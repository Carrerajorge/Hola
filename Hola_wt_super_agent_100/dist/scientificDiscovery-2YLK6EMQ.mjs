...
Variables: ${JSON.stringify(t)}`}],requirements:{tier:"ultra",minContext:16e3}})).content}},u=new r,l=new i,d=new o;export{r as AutomatedResearcher,i as HypothesisGenerator,o as SimulationEngine,l as hypothesis,u as researcher,d as simulator};
