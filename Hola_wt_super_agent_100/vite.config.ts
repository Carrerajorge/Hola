  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        workbox: {
          // Workbox bundles the SW with Rollup+Terser in "production" mode. In
          // restricted sandboxes this can fail with "Unexpected early exit".
          // The SW being unminified is acceptable; keep builds reliable.
          mode: "development",
          disableDevLogs: true,
