...
const envSchema = z.object({
  ...
  // Admin / bootstrap (required in production by seed-production.ts)
...
function validateEnv() {
  ...
  if (!hasAnyLlm) {
    console.warn("⚠️  WARNING: No LLM API keys configured (XAI_API_KEY, GEMINI_API_KEY, OPENAI_API_KEY, ANTHROPIC_API_KEY, or DEEPSEEK_API_KEY)");
